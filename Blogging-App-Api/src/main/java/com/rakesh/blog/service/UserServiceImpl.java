...
public class UserServiceImpl implements IUserService {
	...
	/*
	 * @Override public String createUser(UserDto userDto) { User
	 * user=this.dtoToUser(userDto); return
	 * "saved wtih id"+userRepository.save(user).getUser_id();
	 * 
	 * }
	 */
	...
	public User dtoToUser(UserDto userDto) {
		 ...
		 * user.setUser_name(userDto.getUser_name()); user.setEmail(userDto.getEmail());
	...
	public UserDto userToUserDto(User user) {
		 ...
		 * userDto.setUser_name(user.getUser_name()); userDto.setEmail(user.getEmail());
